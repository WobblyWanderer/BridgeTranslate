  ...
  return (
    <div className="bridge-page">
      <header className="bridge-shell bridge-header">
        <Link className="bridge-brand" href="/" aria-label="Bridge home"><span className="bridge-mark"><img className="bridge-mark-image" src="/wobblywanderer-32.png" alt="" /></span><span className="bridge-brand-word">BRIDGE</span></Link>
