...
Licence summary: https://creativecommons.org/licenses/by-sa/4.0/
...
Software, HTML, CSS, JavaScript, Python, JSON, JSONC, schemas, workflow files and other executable or machine-readable material are licensed under [AGPL-3.0-or-later](LICENSE), unless a file says otherwise. Third-party dependencies remain under their own licences.
